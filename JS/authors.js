...
$(document).ready(function() {
  ...
  $.ajax({
    ...
    for (var i = 0; i < data.length; i++) {
      ...
      const authorList = `<center><div class="well" id="top-well"><h3 class="name">${authorFirst}` + ' ' + `${authorLast}</h3><center><a href="#" class="authorClick"><img src="${authorPortrait}" alt="${authorFirst}` + ' ' + `${authorLast}" id="authorPic"></a></center><p class="bio">${authorBio}</p></div></center><br>`;
